 ...
 * @author chenc
 */
public class PanelEmplDat extends javax.swing.JFrame
{
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(PanelEmplDat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
