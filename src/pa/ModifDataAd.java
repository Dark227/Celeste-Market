 ...
 * @author chenc
 */
public class ModifDataAd extends javax.swing.JFrame
{

    Tools to = new Tools();
    Consultas cl = new Consultas();
    Administrador ad = cl.dataAdmin(LogAdmin.getUser());
    ...
    {//GEN-HEADEREND:event_jLabel8MouseClicked
        ...
        } else
        {
            ...
            if (md.modifiDataAdmin(rfc, LogAdmin.getUser(), name.toUpperCase(), tele))
            {
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(ModifDataAd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new ModifDataAd().setVisible(true);
            }
        });
    }
