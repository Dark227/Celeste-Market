 ...
 * @author chenc
 */
public class NewProve extends javax.swing.JFrame
{
    Tools to = new Tools();
    ...
    private void initComponents()
    {
        ...
        jLabel2.setText("Proveedores existentes");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 70, 230, -1));
    ...
    {//GEN-HEADEREND:event_jLabel4MouseClicked
        ...
        {
            Altas al= new Altas();
            if (al.AltaProve(cate))
            {
                to.aviso("El proveedor fue registrado", "Mensaje de éxito");
                this.dispose();
            }
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(NewProve.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
